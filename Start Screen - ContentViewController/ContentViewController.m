...
- (instancetype)init
{
    self = [super init];
    if (self) {
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/2 - 150.0, [UIScreen mainScreen].bounds.size.height/2 - 250.0, 300.0, 300.0)];
