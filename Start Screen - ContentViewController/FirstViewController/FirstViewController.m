...
//  Tickets
//
//  Created by Ilya Doroshkevitch on 25.01.2021.
//
...
- (void)viewDidLoad {
    ...
    _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(self.view.bounds.size.width - 294, self.view.bounds.size.height - 200.0, 180.0, 50.0)];
    ...
    _nextButton.frame = CGRectMake(self.view.bounds.size.width - 124.0, self.view.bounds.size.height - 200.0, 100.0, 50.0);
